...
This subsystem was first developed as a complete Arcadia-based case study in Capella, covering Operational Analysis, System Analysis, Logical Architecture, and Physical Architecture, with full requirements-to-verification traceability (see full documentation: [Documentation_RailGrinding_Machine_Water_Subsystem_V1.0.pdf](./capella/Documentation_RailGrinding_Machine_Water_Subsystem_V1.0.pdf)).
